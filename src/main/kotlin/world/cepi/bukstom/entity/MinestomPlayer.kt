...
class MinestomPlayer(val minestomPlayer: net.minestom.server.entity.Player, val internalServer: MinestomServer) :
	Player {
	...
	override fun showTitle(
		title: BaseComponent?, subtitle: BaseComponent?, fadeInTicks: Int, stayTicks: Int, fadeOutTicks: Int
	) {
		TODO("Not yet implemented")
	}
	...
	override fun setRotation(yaw: Float, pitch: Float) {
		minestomPlayer.position.let {
			//TODO: Fix this
			it.withYaw(yaw).withPitch(pitch)
		}
	}
	...
	override fun sendPluginMessage(source: Plugin, channel: String, message: ByteArray) {
		minestomPlayer.sendPluginMessage(channel, message)
	}
	...
	override fun getDisplayName(): String {
		return PlainComponentSerializer.plain()
			.serialize(minestomPlayer.displayName ?: Component.text(minestomPlayer.username))
	}
	...
	override fun spawnParticle(
		particle: Particle, location: Location, count: Int, offsetX: Double, offsetY: Double, offsetZ: Double
	) {
		TODO("Not yet implemented")
	}
	...
	override fun <T : Any?> spawnParticle(
		particle: Particle, location: Location, count: Int, offsetX: Double, offsetY: Double, offsetZ: Double, data: T?
	) {
		TODO("Not yet implemented")
	}
